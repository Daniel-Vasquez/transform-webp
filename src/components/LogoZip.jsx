...
export const LogoZip = ({className}) => {
  return (
    <svg
    ...
    >
      <path
        fill="#8199AF"
        fillRule="evenodd"
        d="M5.113-.026A5.074 5.074 0 0 0 .039 5.048v53.841a5.073 5.073 0 0 0 5.074 5.074h45.773a5.074 5.074 0 0 0 5.074-5.074V20.284L37.059-.026H5.113z"
        clipRule="evenodd"
      />
